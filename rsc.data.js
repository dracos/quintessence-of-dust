...
RSC.Events = [
    ...
    { title: 'Of All the People in All the World, Stan’s Café', location: 'Paccar', start: '2012-04-14', end: '2012-07-21' },
    ...
    { title: 'The Rest is Silence', location: 'Newcastle', start: '2012-06-26', end: '2012-06-30' },
    { title: 'In A Pickle', location: 'Newcastle', start: '2012-06-27', end: '2012-06-30' },
    ...
    { title: 'West Side Story', location: 'Newcastle', start: '2012-07-04', end: '2012-07-07' },
    ...
    { title: 'Macbeth : Leila and Ben - A Bloody History', location: 'Newcastle', start: '2012-07-12', end: '2012-07-14' },
    ...
    { title: 'Julius Caesar', location: 'Newcastle', start: '2012-07-19', end: '2012-07-28' },
    ...
    { title: 'Y Storm', location: 'National Eisteddfod of Wales', start: '2012-08-07', end: '2012-08-11' },
    { title: 'Julius Caesar', location: 'Noël Coward Theatre', start: '2012-08-08', end: '2012-09-15' },
    { title: 'Coriolan/us', location: 'Hangar 858', start: '2012-08-09', end: '2012-08-18' },
    { title: "A Midsummer Night's Dream (As You Like It)", location: 'Royal Shakespeare Theatre', start: '2012-08-10', end: '2012-08-18' },
    { title: '2008 : Macbeth', location: 'Edinburgh', start: '2012-08-11', end: '2012-08-18' },
    { title: 'Cesario', location: 'National Theatre', start: '2012-08-22', end: '2012-08-25' },
    { title: 'The Rape of Lucrece', location: 'Edinburgh', start: '2012-08-22', end: '2012-08-26' },
    { title: 'Troilus and Cressida', location: 'Riverside Studios', start: '2012-08-23', end: '2012-09-08' },
    { title: "A Midsummer Night's Dream (As You Like It)", location: 'Edinburgh', start: '2012-08-24', end: '2012-08-26' },
